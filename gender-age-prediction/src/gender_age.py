...
parser = argparse.ArgumentParser(description = 'This script deploys OpenCV to predict Gender and Age.')
parser.add_argument('-i', help = 'Path to input image or video file. Skip this argument to capture face using a webcam.')
