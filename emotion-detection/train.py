...
def addTopModelMobileNet(bottom_model, num_classes): 
    '''
    creates the head of the model which will be placed on 
...
train_data_dir = '/Users/animesh/Documents/sde/projects/emotion-detection/data/train.csv'
validation_data_dir = '/Users/animesh/Documents/sde/projects/emotion-detection/data/test.csv'
...
checkpoint = ModelCheckpoint('emotion_face_MobileNet.h5', monitor = 'val_loss', mode = 'min', save_best_only = True, verbose = 1)
...
model.compile(loss = 'categorical_crossentropy', optimise = Adam(lr = 0.001), metrics = ['accuracy'])
