...
class seller(models.Model):
    name = models.CharField(max_length=50, default='Animesh Okhade')
    address = models.CharField(max_length=150, default='Fortune Pride, Bhopal')
    phone = models.IntegerField(default='+91 9767006053')
