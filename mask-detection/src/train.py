...
ap.add_argument("-p", "--plot", type=str, default="src/graph.png", help="path to output loss/accuracy plot")
ap.add_argument("-m", "--model", type=str, default="src/mask_imagenet.h5", help="path to save output model")
...
# partition the dataset in the ratio of 80:20 for training and testing respectively
...
# the actual model which will be trained)
